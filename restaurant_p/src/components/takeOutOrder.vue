    ...
    >
      ...
      <div style="padding:0px 20px;">
        <el-table row-key="orderId" stripe :data="orderTable" border style="width: 100%;">
          ...
          <el-table-column prop="customer" label="顾客" align="center" width="120px"></el-table-column>
          <el-table-column prop="remake" label="地址" align="center" ></el-table-column>
          <el-table-column prop="userPhone" label="顾客电话" align="center"></el-table-column>
          <el-table-column prop="count" label="总价（元）" align="center" width="100px"></el-table-column>
          <el-table-column prop="discount" label="折后（元）" align="center" width="100px"></el-table-column>
